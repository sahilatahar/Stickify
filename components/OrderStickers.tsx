    ...
    <section className="section">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full px-4 md:w-1/2 md:px-0">
          <h3 className="py-4 text-xl font-semibold">How It Works:</h3>
          <ul className="flex list-decimal flex-col gap-4 pl-4 text-lg">
            <li>
              ...
              <p className="text-text-secondary">
                Fill google form on our website, including your details.
              </p>
            ...
            <li>
              ...
              <p className="text-text-secondary">
                Easily upload your own images through the form, or browse and
                download stickers from our pre-designed{' '}
            ...
            <li>
              ...
              <p className="text-text-secondary">
                Send us a message on WhatsApp with your name to confirm your
                order.
              </p>
            ...
            <li>
              ...
              <p className="text-text-secondary">
                Once payment is confirmed, we’ll print and ship your stickers
                right to your door.
              </p>
            </li>
          </ul>
