        ...
        <>
            ...
            <section className="section mx-auto max-w-screen-lg pt-16 text-center">
                ...
                <h3 className="pt-4 text-xl font-medium text-text-secondary">
                    Turn your favorite photos into high-quality, sticky
                    stickers!
                </h3>
                <p className="pt-6 text-lg text-text-secondary">
                    Bring your photos to life with custom stickers that are
                    perfect for any occasion. Whether you want to personalize
                    your laptop, decorate your space, or add a unique touch to
                    your gifts, our stickers are the perfect choice. Simply
                    upload your image, and we will handle the rest. Our durable,
                    waterproof stickers are printed with care and delivered
                    straight to your door. Start sticking your style everywhere
                    you go!
                </p>
            </section>
        </>
