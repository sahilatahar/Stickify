    ...
    return (
        <section className="section pt-8">
            ...
            <p className="mx-auto max-w-screen-lg px-4 text-center text-lg text-text-secondary">
                Explore our gallery of ready-made stickers. Just click on a
                sticker to download it, and when you&apos;re placing your order,
                you can upload the sticker you chose or your own custom image.
                It&apos;s that easy!
            </p>
